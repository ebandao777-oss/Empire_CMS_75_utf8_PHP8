...
function SetFirewall($add,$userid,$username){
	...
	//时间点
	$hour=array();
	if(isset($add['fw_adminhour']))$hour=$add['fw_adminhour'];
	$hcount=php8_count($hour);
	$adminhour='';
	if($hcount)
	{
		$dh='';
	...
	//星期
	$week=array();
	if(isset($add['fw_adminweek']))	$week=$add['fw_adminweek'];
	$wcount=php8_count($week);
	$adminweek='';
	if($wcount)
	{
		$dh='';
...
function SetSafe($add,$userid,$username){
	...
	$r['do_enloginauth']=0;
	if(isset($add['enloginauth']))$r['do_enloginauth']=(int)$add['enloginauth'];
	$r['do_ecookiernd']=$add['ecookiernd'];
	$r['do_ckhloginip']=(int)$add['ckhloginip'];
	$r['do_ckhsession']=(int)$add['ckhsession'];
	$r['do_ckhanytime']=0;
	if(isset($add['ckhanytime']))$r['do_ckhanytime']=(int)$add['ckhanytime'];
