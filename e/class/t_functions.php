...
//带模板的标签
function sys_GetEcmsInfo($classid,$line,$strlen,$have_class,$enews,$tempid,$doing=0,$ewhere='',$eorder=''){
	global $empire,$public_r;
	if(!$have_class)$have_class=0;
	if(!$enews)$enews=0;
...
//图文信息调用
function sys_GetClassNewsPic($classid,$line,$num,$width,$height,$showtitle,$strlen,$enews=0,$ewhere='',$eorder=''){
	global $empire;
	if($showtitle！===false)$showtitle=true;
...
//带模板的标签显示-循环
function sys_GetEcmsInfoMore($classid,$line,$strlen,$have_class,$ecms,$tr,$doing,$field,$cr,$dofirstinfo=0,$fsubtitle=0,$fsubnews=0,$fdoing=0,$ewhere='',$eorder=''){
	global $empire,$public_r;
	if(!$have_class)$have_class=0;
	if(!$ecms)$ecms=0;
	if(!$doing)$doing=0;
...
//循环子栏目数据
function sys_ForSonclassData($classid,$line,$strlen,$have_class,$enews,$tempid,$doing=0,$cline=0,$dofirstinfo=0,$fsubtitle=0,$fsubnews=0,$fdoing=0,$ewhere='',$eorder=''){
